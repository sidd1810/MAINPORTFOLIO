...
const CollectionBtn= () => {
  ...
  return (
    <StyledWrapper className='sm:w-fit w-2/5 mx-auto'>
      <div className="main">
        <div className="up">
          <button className="card1" onClick={() => window.location.href = "https://www.instagram.com"}>
          ...
          <button className="card2" onClick={() => window.location.href = "https://x.com/i/flow/login?input_flow_data=%7B%22requested_variant%22%3A%22eyJsYW5nIjoiZW4ifQ%3D%3D%22%7D&mx=2"} >
        ...
        <div className="down"  onClick={() => window.location.href = "https://github.com/sidd1810"} >
          ...
          <button className="card4"  onClick={() => window.location.href = "https://github.com/sidd1810"} >
